...
AssertToolkit.pureArray = function(name) {
    var initialConcrete = '';
    var resultArray = [AssertToolkit.symbol(name, initialConcrete), AssertToolkit.symbol(name, initialConcrete), AssertToolkit.symbol(name, initialConcrete), AssertToolkit.symbol(name, initialConcrete)];
    return resultArray;
}
...
AssertToolkit.symbol = function(name, c) {
    ...
    if (typeof(c) == 'undefined') {
        return AssertToolkit.pureSymbol(AssertToolkit.resolveSymbolName(name) + 'pure_symbol');
    }
...
AssertToolkit.pureSymbol = function(name) {
	...
	case 4:
            return AssertToolkit.pureArray(name);
	default:
